...
#define ENCAPIN 2               // pin used for encoder a
...
void setup_gpio_pcnt(void)
{
    ...
    REG_VAL(GPIO_FUNC2_OUT_SEL_CFG_REG) |= GPIO_FUNC2_OEN_SEL;
    ...
    REG_VAL(IO_MUX_GPIO2_REG) |= FUN_IE | 2 << MCU_SEL_S;      // enable fun_ie and AF to 2
